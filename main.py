...
if __name__ == '__main__':
    ...
    parser.add_argument('--reg_weight', type=float, default=1e-4, help='')
    parser.add_argument('--layers', type=int, default=2)

    parser.add_argument('--data_name', type=str, default='ijcai', help='')
    parser.add_argument('--behaviors', default=None, type=ast.literal_eval, help='')
    ...
    parser.add_argument('--metrics', type=list, default=['hit', 'recall', 'ndcg'], help='')
    ...
    parser.add_argument('--model_name', type=str, default='model_lightGCN', help='')
    parser.add_argument('--data_loader', type=str, default='data_set', help='')
    ...
    data_loader = __import__(args.data_loader)
    dataset = getattr(data_loader, 'DataSet')(args)
    ...
    # model = VAEM(args, dataset).to(args.device)
    modules = __import__(args.model_name)
    model = getattr(modules, 'ACMBR')(args, dataset).to(args.device)
